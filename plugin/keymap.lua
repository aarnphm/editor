...
map("n", "<leader>?", "<cmd>Cheatsheet<cr>", { desc = "help: keyboard shortcut cheatsheet" })
map("n", "<leader>:", "<cmd>Cheatsheet commands<cr>", { desc = "help: command cheatsheet" })
map("n", "<leader>ls", "<cmd>LatexShortcut<cr>", { desc = "latex: shortcut cheatsheet" })
...
map("x", "mmm", apply_macro_to_visual_selection, { desc = "macro: apply to selection" })
...
map("n", "<Leader>rr", "<cmd>restart<cr>", { desc = "editor: restart" })
