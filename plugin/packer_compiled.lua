...
_G.packer_plugins = {
  ...
  ["gitsigns.nvim"] = {
    config = { "\27LJ\2\n�\b\0\0\5\0\14\0\0176\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\b\0005\3\3\0005\4\4\0=\4\5\0035\4\6\0=\4\a\3=\3\t\0025\3\n\0=\3\v\0025\3\f\0=\3\r\2B\0\2\1K\0\1\0\14diff_opts\1\0\1\rinternal\2\28current_line_blame_opts\1\0\2\ndelay\3�\a\21virtual_text_pos\beol\fkeymaps\1\0\3\23current_line_blame\2\14word_diff\2\nnumhl\2\22n <LocalLeader>[g\1\2\1\0@&diff ? '[g' : '<cmd>lua require\"gitsigns\".prev_hunk()<CR>'\texpr\2\22n <LocalLeader>]g\1\2\1\0@&diff ? ']g' : '<cmd>lua require\"gitsigns\".next_hunk()<CR>'\texpr\2\1\0\f\22n <LocalLeader>hu7<cmd>lua require(\"gitsigns\").undo_stage_hunk()<CR>\tx ih4:<C-U>lua require(\"gitsigns\").text_object()<CR>\22n <LocalLeader>hs2<cmd>lua require(\"gitsigns\").stage_hunk()<CR>\22n <LocalLeader>hr2<cmd>lua require(\"gitsigns\").reset_hunk()<CR>\fnoremap\2\22v <LocalLeader>hrV<cmd>lua require(\"gitsigns\").reset_hunk({vim.fn.line(\".\"), vim.fn.line(\"v\")})<CR>\to ih4:<C-U>lua require(\"gitsigns\").text_object()<CR>\22n <LocalLeader>hp4<cmd>lua require(\"gitsigns\").preview_hunk()<CR>\22v <LocalLeader>hsV<cmd>lua require(\"gitsigns\").stage_hunk({vim.fn.line(\".\"), vim.fn.line(\"v\")})<CR>\22n <LocalLeader>hb?<cmd>lua require(\"gitsigns\").blame_line({full = true})<CR>\22n <LocalLeader>hR4<cmd>lua require(\"gitsigns\").reset_buffer()<CR>\vbuffer\2\nsetup\rgitsigns\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-navic", "lspsaga.nvim", "lsp_signature.nvim" },
  ...
  ["nvim-navic"] = {
    after = { "lualine.nvim" },
    config = { "\27LJ\2\n�\3\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\nicons\1\0\2\14highlight\2\14separator\t » \1\0\26\14Namespace\t \fPackage\t \nArray\t \bKey\t \rConstant\t \fBoolean\t \vNumber\t \vStruct\t \vObject\t \14Interface\t \nClass\tﴯ \16Constructor\t \nField\t \rOperator\t \tNull\tﳠ \tEnum\t \vString\t \rFunction\t \vMethod\t \vModule\t \rProperty\tﰠ \tFile\t \rVariable\t \15EnumMember\t \nEvent\t \18TypeParameter\t \nsetup\15nvim-navic\frequire\0" },
    load_after = {
      ["nvim-lspconfig"] = true
    },
    loaded = false,
  ...
  ["trouble.nvim"] = {
    ...
    config = { "\27LJ\2\n�\2\0\0\4\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\0025\3\6\0=\3\a\2B\0\2\1K\0\1\0\nsigns\1\0\5\nother\b﫠\16information\b\thint\b\fwarning\b\nerror\b\14auto_jump\1\2\0\0\20lsp_definitions\1\0\b\29use_lsp_diagnostic_signs\1\tmode\25document_diagnostics\16fold_closed\b\17indent_lines\1\14fold_open\b\17auto_preview\2\14auto_fold\1\15auto_close\2\nsetup\ftrouble\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
