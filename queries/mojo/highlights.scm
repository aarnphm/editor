; Based on tree-sitter-mojo's bundled query, with the Python-derived docstring
; pattern removed because Mojo function bodies do not use expression_statement.
