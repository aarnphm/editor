return function()
  ...
  k.nvim_load_mapping({
    ["n|<Leader>ct"] = k.map_callback(crates.toggle):with_defaults():with_desc("crates: Toggle"),
    ["n|<Leader>cr"] = k.map_callback(crates.reload):with_defaults():with_desc("crates: reload"),
    ...
    ["n|<Leader>cu"] = k.map_callback(crates.update_crate):with_defaults():with_desc("crates: update crate"),
    ["v|<Leader>cu"] = k.map_callback(crates.update_crates):with_defaults():with_desc("crates: update crates"),
    ["n|<Leader>ca"] = k.map_callback(crates.update_all_crates):with_defaults():with_desc("crates: update all crates"),
    ["n|<Leader>cU"] = k.map_callback(crates.upgrade_crate):with_defaults():with_desc("crates: upgrade crate"),
    ["v|<Leader>cU"] = k.map_callback(crates.upgrade_crates):with_defaults():with_desc("crates: upgrade crates"),
    ["n|<Leader>cA"] = k.map_callback(crates.upgrade_all_crates)
      :with_defaults()
      :with_desc("crates: upgrade all crates"),
    ["n|<Leader>cH"] = k.map_callback(crates.open_homepage):with_defaults():with_desc("crates: show homepage"),
    ["n|<Leader>cR"] = k.map_callback(crates.open_repository):with_defaults():with_desc("crates: show repository"),
    ["n|<Leader>cD"] = k.map_callback(crates.open_documentation)
      :with_defaults()
      :with_desc("crates: show documentation"),
    ["n|<Leader>cC"] = k.map_callback(crates.open_crates_io):with_defaults():with_desc("crates: open crates.io"),
  })
end
