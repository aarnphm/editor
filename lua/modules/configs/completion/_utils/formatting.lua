	...
	vim.api.nvim_create_autocmd("BufWritePre", {
		...
		callback = function()
			if vim.tbl_contains({ "gitcommit", "gitrebase" }, vim.bo.filetype) then
				...
				require("completion._utils.formatting").format { timeout_ms = opts.timeout, filter = M.format_filter }
			end
		end,
	})
...
M.format_filter = function(clients)
	return vim.tbl_filter(function(client)
		local status_ok, formatting_supported = pcall(
			function() return client.supports_method "textDocument/formatting" end
		)
