...
M.setup = function()
  ...
  local def_map = {
    ...
    ["n|<LocalLeader>vs"] = map_cu("vsplit"):with_noremap():with_silent(),
    ["n|<LocalLeader>hs"] = map_cu("split"):with_noremap():with_silent(),
    ["n|<leader>vs"] = map_cmd(':vsplit <C-r>=expand("%:p:h")<cr>/'):with_noremap(),
    ["n|<leader>hs"] = map_cmd(':split <C-r>=expand("%:p:h")<cr>/'):with_noremap(),
  ...
  local plug_map = {
    ...
    -- Lazy
    ["n|<Space>ls"] = map_cr("Lazy sync"):with_noremap():with_silent(),
    ["n|<Space>lc"] = map_cr("Lazy clean"):with_noremap():with_silent(),
    ["n|<Space>lu"] = map_cr("Lazy update"):with_noremap():with_silent(),
    ["n|<Space>lcc"] = map_cr("Lazy check"):with_noremap():with_silent(),
    ["n|<Space>lh"] = map_cr("Lazy home"):with_noremap():with_silent(),
    -- Gitsigns
    ...
    ["n|<F6>"] = map_cr([[execute v:count . "ToggleTerm direction=float"]]):with_noremap():with_silent(),
    ["i|<F6>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=float<CR>"):with_noremap():with_silent(),
    ["t|<F6>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),
    ["n|<F7>"] = map_cu("lua require('core.utils').gitui()"):with_noremap():with_silent(),
    ["n|<F8>"] = map_cu("lua require('core.utils').create_float_term()"):with_noremap():with_silent(),
