...
local plug_map = {
  ...
  ["n|ftt"] = map_cu('lua require("FTerm").toggle()'):with_noremap():with_silent(),
  ["t|ftt"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").toggle()]]):with_noremap():with_silent(),
  ["t|fte"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").exit()]]):with_noremap():with_silent(),
