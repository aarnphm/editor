...
local plug_map = {
  ...
  ["n|tt"] = map_cu('lua require("FTerm").toggle()'):with_noremap():with_silent(),
  ["t|<Leader>tt"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").toggle()]]):with_noremap():with_silent(),
  ["t|<Leader>te"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").exit()]]):with_noremap():with_silent(),
