...
local M = setmetatable({}, {
  ---@param m lazyvim.util.root
  __call = function(m) return m.get() end,
})

---@class SimpleRoot
---@field paths string[]
---@field spec SimpleRootSpec

---@alias SimpleRootFn fun(buf: number): (string|string[])
...
---@param opts? { buf?: number, spec?: SimpleRootSpec[], all?: boolean }
function M.detect(opts)
  opts = opts or {}
  opts.spec = opts.spec or type(vim.g.root_spec) == "table" and vim.g.root_spec or M.spec
  opts.buf = (opts.buf == nil or opts.buf == 0) and vim.api.nvim_get_current_buf() or opts.buf

  local ret = {} ---@type SimpleRoot[]
