...
_G.ZoxIcon = {
	...
	DocumentsSpace = setmetatable(
		{},
		{ __index = function(_, key) return data.documents[key] .. " " end }
	),
	Git = data.git,
	...
	DiagnosticsSpace = setmetatable(
		{},
		{ __index = function(_, key) return data.diagnostics[key] .. " " end }
	),
	Misc = data.misc,
